...
// --- SVG иконки (копируем из Login.tsx) ---
const EyeOpenIcon = () => (
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (userId) {
        ...
        await achievementService.updateAchievementProgress(userId, 'profile-register', 1);
        console.log(`User registered, achievement updated for userId: ${userId}`);
